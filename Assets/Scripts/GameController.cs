...
public class GameController : MonoBehaviour {
    ...
    public TextMeshProUGUI timeValue, levelValue, linesValue, stageValue, scoreValue, gameModeValue;
    //[Space] public TextMeshProUGUI timeVal;
    ...
    public async void HandleLeftMovementInput(InputAction.CallbackContext context)
    {
        //Debug.Log(context);
    ...
    public async void HandleRightMovementInput(InputAction.CallbackContext context)
    {
        /*if (context.performed)
        {
            HorizontalMove(Vector3.right);
    ...
    public async void HandleRotationInput(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
            rotateHeld = true;
    ...
    public async void HandleDropInput(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
            downHeld = true;
            ...
            while (downHeld)
            {
                if (ValidMove(currBlock.transform) && !hardDropped)
                {
                    VerticalMove(Vector3.down);
                }
    ...
    public void HandleOkInput(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
            while (ValidMove(currBlock.transform) && !hardDropped)
